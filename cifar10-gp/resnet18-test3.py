...
# new objective, inner consists of mixed data
...
parser.add_argument('--save', default='p100', type=str, help='save path for dataloader')
...
if args.plrsch == 'fixed':
    ...
    lr_schedule = lambda t: np.interp([t], [0, args.epochs // 3, args.epochs * 2 // 3, args.epochs], [args.plr, args.plr, args.plr / 10, args.plr / 100])[0]
