...
parser.add_argument('--plr', default=0.007, type=float, help='learning rate of poison')
...
parser.add_argument('--outer', default=10, type=int, help='pgd steps')
#parser.add_argument('')
...
for epoch in range(args.epochs):
    ...
    np.savetxt('sharp/resnet18CIpgd/'+args.save+'_sharp.txt', np.array(sharpness))#store sharpness
    ...
    plt.savefig('./figures/resnet18CIpgd/'+args.save+'_sharp.png')
...
print('==> Data saving..')
np.save('poisoned/resnet18CIpgd/'+args.save+'_gpimage.npy', poisonimage_np)
np.save('poisoned/resnet18CIpgd/'+args.save+'_gplabel.npy', poisonlabel_np)