...
optimizer_clean = SAM(net_clean.parameters(), base_optimizer, lr=args.lr, momentum=0.9)
...
def test(epoch, net):
    ...
    if acc > best_acc:
        ...
        torch.save(state, './Cifar10checkpoint/ResNet18-SAM.pth')
        best_acc = acc
...
for epoch in range(start_epoch, start_epoch+200):
    ...
    np.savetxt('results/testAcc_clean-SAM.txt', acc_np)
...
plt.savefig('./figures/Cifar10_ResNet18_clean-SAM.png')
print('Figure saved.')