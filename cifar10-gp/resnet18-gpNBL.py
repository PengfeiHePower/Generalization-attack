...
parser.add_argument('--ad', default=0, type = int, help='whether adaptive lr or not')
#parser.add_argument('')
...
for epoch in range(args.epochs):
    ...
    loss_all = loss_cal(net, criterion, innerloader, optimizer)
    sharpness.append(loss_all)
    np.savetxt('sharp/resnet18NBL/'+args.save+'_sharp.txt', np.array(sharpness))#store sharpness
    ...
    plt.savefig('./figures/resnet18NBL/'+args.save+'_sharp.png')
...
print('==> Data saving..')
np.save('poisoned/resnet18NBL/'+args.save+'_gpimage.npy', poisonimage_np)
np.save('poisoned/resnet18NBL/'+args.save+'_gplabel.npy', poisonlabel_np)