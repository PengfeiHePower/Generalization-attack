...
for epoch in range(args.epochs):
    ...
    np.savetxt('sharp/resnet18NBR2/'+args.save+'_sharp.txt', np.array(sharpness))#store sharpness
    ...
    plt.savefig('./figures/resnet18NBR2/'+args.save+'_sharp.png')
    ...
    np.save('poisoned/resnet18NBR2/'+args.save+'_gpimage.npy', poisonimage_np)
    np.save('poisoned/resnet18NBR2/'+args.save+'_gplabel.npy', poisonlabel_np)
