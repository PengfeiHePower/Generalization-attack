...
for epoch in range(args.epochs):
    ...
    np.savetxt('sharp/resnet18CID/'+args.save+'_sharp.txt', np.array(sharpness))#store sharpness
    ...
    plt.savefig('./figures/resnet18CID/'+args.save+'_sharp.png')
...
print('==> Data saving..')
np.save('poisoned/resnet18CID/'+args.save+'_gpimage.npy', poisonimage_np)
np.save('poisoned/resnet18CID/'+args.save+'_gplabel.npy', poisonlabel_np)