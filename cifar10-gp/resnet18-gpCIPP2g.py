...
def test(epoch, net):
    ...
    if not os.path.isdir('Cifar10checkpoint/poisongen/resnet18CIPP2g'):
        os.mkdir('Cifar10checkpoint/poisongen/resnet18CIPP2g')
    torch.save(state, './Cifar10checkpoint/poisongen/resnet18CIPP2g/' +args.save+'_test_RN18_gp.pth') 
...
for epoch in range(args.epochs):
    ...
    np.save('poisoned/resnet18CIPP2g/'+args.save+'_gpimage.npy', poisonimage_np)
    np.save('poisoned/resnet18CIPP2g/'+args.save+'_gplabel.npy', poisonlabel_np)
